...
export default function Edit({ project }) {
    ...
    return (
        <AuthenticatedLayout header="Edit Project">
            ...
            {/* Form Wrapper - Settings Panel style */}
            <div className="bg-[#c0c0c0] p-4 border-t-2 border-l-2 border-t-white border-l-white border-r-2 border-b-2 border-r-[#808080] border-b-[#808080] shadow-[1px_1px_0_#000]">
                <form onSubmit={submit} className="space-y-4">
                    ...
                    {/* File Input */}
                    <div>
                        <label className="block text-sm font-bold text-black mb-1">Project Image (Leave empty to keep current)</label>
                        {project.image && (
                            <div className="mb-2 p-2 bg-white border-t-2 border-l-2 border-t-[#808080] border-l-[#808080] border-r-2 border-b-2 border-r-white border-b-white shadow-[-1px_-1px_0_#000_inset] inline-block">
                                <img src={`/storage/${project.image}`} alt="Current" className="h-32 object-cover" />
                            </div>
                        )}
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        >
                            <Save className="w-4 h-4" /> {processing ? 'Saving...' : 'Update Project'}
                        </button>
                    </div>
                </form>
            </div>
